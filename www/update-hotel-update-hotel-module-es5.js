...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["update-hotel-update-hotel-module"], {
  ...
  function srcAppUpdateHotelUpdateHotelPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UpdateHotelPage = /*#__PURE__*/function () {
      function UpdateHotelPage(activatedRoute, fbService, router, http) {
      ...
      _createClass(UpdateHotelPage, [{
        ...
        value: function uploadPic(event) {
          ...
          this.http.post('https://upload.uploadcare.com/base/', data).subscribe(function (event) {
            ...
            _this3.hotel.image = "https://ucarecdn.com/".concat(uuid, "/-/scale_crop/150x150/center/"); // this.mainuser.update({
            // 	profilePic: uuid
            // })
          });
        }
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('fileBtn', {
      "static": false
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)], UpdateHotelPage.prototype, "fileBtn", void 0);
